...
export function IconOverview(props: { size?: number }) {
  return (
    <Svg {...props}>
...
export function IconLibrary(props: { size?: number }) {
  return (
    <Svg {...props}>
...
export function IconBacklog(props: { size?: number }) {
  return (
    <Svg {...props}>
      <path d="M11 12H3" />
      <path d="M16 6H3" />
...
export function IconSync(props: { size?: number }) {
  return (
    <Svg {...props}>
...
export function IconPlayStation(props: { size?: number }) {
  return (
    <BrandSvg {...props}>
...
export function IconSteam(props: { size?: number }) {
  return (
    <BrandSvg {...props}>
...
export function IconSwitch(props: { size?: number }) {
  return (
    <BrandSvg {...props}>
...
export function IconXbox(props: { size?: number }) {
  return (
    <BrandSvg {...props}>
 ...
 * to. Every PlayStation generation collapses to "psn" so they share one logo and chip style.
 * Returns null when nothing matches (e.g. "PC").
 */
...
/** The brand logo for a platform label or provider, or null when no brand matches. */
